...
new_a = np.array(animals)

new_a.dtype

df = pd.DataFrame(new_a , columns = ['names' , 'speed' , 'lifespan'])

#print(df['lifespan'][2])
#print(df['lifespan'].dtype)

#print(df['names'][2])
#print(df.names.dtype)

df.loc[2 , 'names'] = 'grey elephant'
...
newT = pd.DataFrame(df).to_numpy()
#print(newT.dtype)

#print(df)
df[['speed','lifespan']].astype(float , copy = False)
